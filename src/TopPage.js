...
class TopPage extends Component {
  render() {
    ...
    const Links = [
      ...
      { pageUrl: 'https://fkatsuhiro.github.io/replace-techblog', imgUrl: Webtext, componentName: '技術ブログ( リプレイス版 React.js )' },
      { pageUrl: 'https://fkatsuhiro.github.io/webtext/', imgUrl: Webtext, componentName: '技術ブログ( Vue.js )' },
